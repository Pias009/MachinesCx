...
const ADDRESS = "Wenzhou, Zhejiang, China";
      ...
      <div className="ct-page">
        <div className="ct-wrap">
          <div className="ct-header">
            ...
            <p className="ct-sub">
              Reach us directly using any of the details below, or send an inquiry and our engineering team will get back to you within 24 hours.
            </p>
          </div>
          ...
          <div className="ct-grid">
            {CONTACT_METHODS.map((m) =>
              m.href ? (
                ...
                <div key={m.label} className="ct-card">
                  <span className="ct-card__icon">{m.icon}</span>
                  <span className="ct-card__body">
                    <span className="ct-card__label">{m.label}</span>
                    <p className="ct-card__value">{m.value}</p>
          ...
          <TransitionLink href="/inquiries">
            <div className="ct-cta">
              ...
              <div className="ct-cta__body">
                <h2 className="ct-cta__title">Send an Inquiry</h2>
                <p className="ct-cta__desc">
                  Tell us what you&rsquo;re looking for — select machines, request a quote, or ask about spare parts. Our team reviews every inquiry personally.
                </p>
              </div>
